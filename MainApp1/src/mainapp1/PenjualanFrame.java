...
private void calculateTotalBiaya() {
    try {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            if (rsMobil.next()) {
                ...
                BigDecimal hargaMobil = rsMobil.getBigDecimal("harga");
                
                // Hitung total biaya berdasarkan quantity dan harga mobil
                totalBiaya = hargaMobil.multiply(BigDecimal.valueOf(quantity));
            }
        }

        // Set hasil total biaya ke text field
        txtTotalBiaya.setText(totalBiaya.toPlainString());
    ...
    private void addPenjualan() {
        ...
        String selectedMobil = (String) cmbMobil.getSelectedItem();
        int quantity = Integer.parseInt(txtQuantity.getText());
        BigDecimal totalBiaya = new BigDecimal(txtTotalBiaya.getText());
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            stmtInsert.setBigDecimal(4, totalBiaya);
    ...
    private void updatePenjualan() {
        ...
        if (selectedRow != -1) {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                ...
                stmtUpdate.setBigDecimal(2, totalBiaya);
